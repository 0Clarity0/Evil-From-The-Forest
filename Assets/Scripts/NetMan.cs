...
public class NetMan : NetworkManager
{
    ...
    public void OnCreateCharacter(NetworkConnection conn, PosMessage message)
    {
        ...
        bool v = NetworkServer.AddPlayerForConnection((NetworkConnectionToClient)conn, go); //присоеднияем gameObject к пулу сетевых объектов и отправляем информацию об этом остальным игрокам
    }
